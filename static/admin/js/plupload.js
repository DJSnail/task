...
function plupFile(file,btn,inputName,maxFileSize,ext)
{
    if (!ext) {
        ext = "pdf";
    }
    ...
    var uploader = new plupload.Uploader({ //创建实例的构造方法 
        ...
        url: url, 
        //远程上传地址 
        flash_swf_url: '/static/admin/Plugins/plupload-2.1.2/js/Moxie.swf', 
        //flash文件地址 
        silverlight_xap_url: '/static/admin/Plugins/plupload-2.1.2/js/Moxie.xap', 
        //silverlight文件地址 
        filters: { 
        ...
        init: { 
            ...
            FileUploaded: function(up, file, info) { //文件上传成功的时候触发 
                ...
                }else
                {
                    ...
                    $('input[name='+inputName+'_id]').val(data.id);
 ...
 * @return {[type]}               [void]
 */
function plupImage(file,width,height,btn,imgShowId,inputName,maxFileSize,ext)
{
    if (!ext) {
        ext = 'jpg,png,gif';
    }
